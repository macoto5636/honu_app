  ...
  runApp(
    ...
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => MyMemoryProvider()),
        ChangeNotifierProvider(create: (_) => OtherMemoryProvider()),
      ],
      child: MyApp(),
    ),
  );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        child: _currentIndex == 0 ? NoticePage() :
         _currentIndex == 2 ? ConfigPage() :
         Container(
